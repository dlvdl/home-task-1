...
${data
  .map(({ name, created, category, content, dates, id, archived }) => {
    ...
    <td class="table-cell">
      ...
      <button>
      <a  href="https://home-task-1.onrender.com/pages/edit_todo_page.html?id=${id}">
...
<div class="button-box">
  <a class="save-button" href="https://home-task-1.onrender.com/pages/create_todo_page.html"><i class="fa-solid fa-plus"></i></a>
</div>
